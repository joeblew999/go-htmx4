...
This plan owns:
- static `robots.txt` pointing at `/sitemap.xml`
...
| --- | --- | --- |
| robots.txt, Search Console verification file | **Static files** in Static Assets (and the native file server) | Go handlers or `SITE_URL` plumbing for them |
