...
// Greeting answers POST /greet: the main swap into #greeting plus an
// out-of-band toast appended to the gsxui toaster (gsxui toaster docs:
// hx-swap-oob="beforeend:#gsxui-toaster", no htmx-specific JS).
