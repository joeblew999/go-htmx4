...
// chromeTrimmedZones are the zoneStrings entries Chromium's ICU data filter removes for every locale
// (https://chromium.googlesource.com/chromium/deps/icu/+/refs/heads/main/filters/common.json, the
// "zone_tree" rules): a zone id removes the zone's names and exemplar city, a "/ec" suffix only its
// exemplar city. Chrome and Cloudflare Workers ship that data, so ICU there derives exemplar cities from
// the zone id (America/St_Johns → "St Johns"); cldrgen does the same to match their Intl output.
// Ids use ICU's ":" separator, as in the filter.
const chromeTrimmedZones = `
...
Africa:Sao_Tome Africa:Tripoli Africa:Tunis Africa:Windhoek America:Adak America:Anchorage America:Anguilla
...
America:Argentina:Ushuaia America:Aruba America:Asuncion America:Bahia America:Bahia_Banderas America:Barbados
...
America:Eirunepe America:El_Salvador America:Fortaleza America:Fort_Nelson America:Glace_Bay America:Godthab
...
America:Indiana:Vincennes America:Indiana:Winamac America:Inuvik America:Iqaluit America:Jamaica America:Jujuy
America:Juneau America:Kentucky:Monticello America:Kralendijk America:La_Paz America:Lima America:Los_Angeles
...
Asia:Atyrau Asia:Baghdad Asia:Bahrain Asia:Baku Asia:Bangkok Asia:Barnaul Asia:Beirut Asia:Bishkek Asia:Brunei
Asia:Calcutta Asia:Chita Asia:Choibalsan Asia:Colombo Asia:Damascus Asia:Dhaka Asia:Dili Asia:Dubai
Asia:Dushanbe Asia:Famagusta Asia:Gaza Asia:Hebron Asia:Hong_Kong Asia:Hovd Asia:Irkutsk Asia:Jakarta
Asia:Jayapura Asia:Jerusalem Asia:Kabul Asia:Kamchatka Asia:Karachi Asia:Katmandu Asia:Khandyga
...
Asia:Vientiane Asia:Vladivostok Asia:Yakutsk Asia:Yekaterinburg Asia:Yerevan Atlantic:Azores Atlantic:Bermuda
Atlantic:Canary Atlantic:Cape_Verde Atlantic:Faeroe Atlantic:Madeira Atlantic:Reykjavik Atlantic:South_Georgia
Atlantic:Stanley Atlantic:St_Helena Australia:Adelaide Australia:Brisbane Australia:Broken_Hill
Australia:Currie Australia:Darwin Australia:Eucla Australia:Hobart Australia:Lindeman Australia:Lord_Howe
Australia:Melbourne Australia:Perth Australia:Sydney Etc:Unknown Etc:UTC/ec Europe:Amsterdam Europe:Andorra
Europe:Astrakhan Europe:Athens Europe:Belgrade Europe:Berlin Europe:Bratislava Europe:Brussels
Europe:Bucharest Europe:Budapest Europe:Busingen Europe:Chisinau Europe:Copenhagen Europe:Dublin/ec
Europe:Gibraltar Europe:Guernsey Europe:Helsinki Europe:Isle_of_Man Europe:Istanbul Europe:Jersey
Europe:Kaliningrad Europe:Kiev Europe:Kirov Europe:Lisbon Europe:Ljubljana Europe:London/ec Europe:Luxembourg
...
Indian:Reunion Pacific:Apia Pacific:Auckland Pacific:Bougainville Pacific:Chatham Pacific:Easter Pacific:Efate
Pacific:Enderbury Pacific:Fakaofo Pacific:Fiji Pacific:Funafuti Pacific:Galapagos Pacific:Gambier
Pacific:Guadalcanal Pacific:Guam Pacific:Honolulu/ec Pacific:Johnston Pacific:Kiritimati Pacific:Kosrae
