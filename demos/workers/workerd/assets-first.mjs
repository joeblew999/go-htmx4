...
//
// Serve a file from public/ when one exists, otherwise hand the request to the Go Worker:
...
// Not deployed: on Cloudflare, public/ is uploaded as Static Assets instead.
